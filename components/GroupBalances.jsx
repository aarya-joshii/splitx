...
const GroupBalances = ({ balances }) => {
  ...
  console.log("balances", balances, me)
  ...
  return (
    <div className="space-y-4">
      <div className="text-center pb-4 border-b border-purple-300">
        <p className="text-sm text-muted-foreground mb-1">Your Balance</p>
        <p
          className={`text-2xl font-bold ${me.totalBalance > 0 ? 'text-green-500' : me.totalBalance < 0 ? 'text-red-500' : ''}`}
        >
          {me.totalBalance > 0
